...
//    LoadingScreenViewController *loadingScreen = [[LoadingScreenViewController alloc] init];
//    //    [self showViewController:loadingScreen];
//    
//    [self presentViewController:loadingScreen animated:NO completion:nil];
